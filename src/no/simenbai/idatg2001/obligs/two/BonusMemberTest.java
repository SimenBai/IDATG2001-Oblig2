...
/*** Test class used to test the calculation of bonus points in the different classes* representing the different memberships.* To use this class, you first have to set up the Unit-test framework in your IDE.*/
class BonusMemberTest {
    ...
    /*** Tests the accuracy of the calculation of points for the basic member Ole.* Ole was registered as Basic Member more than 365 days before 10/2-2008, and* should not qualify for upgrade.*/
    @Test
    ...
    /*** Tests the accuracy of the calculation of points for the absic member Tove,* who was registered with basic membership less than 365 days before 10/2-2008,* and hence does qualify for an upgrade, first to Silver, then to Gold.*/
    @Test
